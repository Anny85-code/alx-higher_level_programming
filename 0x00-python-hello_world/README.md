# Hello, World
Project done during **Full Stack Software Engineering studies** at **Alx-Africa**. It aims to learn about variables, basics commands (print) and handle strings with **Python**.
...
| `102-magic_calculation.py` | Python function that does exactly the same as a given disassembler |i
